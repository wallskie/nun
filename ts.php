                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" readonly value="<?= $res['nisn'] ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="last-name-column">Angkatan</label>
                                            <input type="text" class="form-control" readonly value="<?= $res['nama_angkatan'] ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="city-column">Jurusan</label>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="email-id-column">TTL</label>
                                            <input type="text" class="form-control mb-2" required name="ttl" value="<?= $res['ttl'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="email-id-column">Jenis Kelamin</label>
